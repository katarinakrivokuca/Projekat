...
\begin{abstract}
Belmanov problem tra\v zenja najkra\' ceg izlanog puta iz \v sume poznatog oblika i dimenzija je re\v sen za mali broj \v suma. Jedan od re\v senih slu\v cajeva je traka ograni\v cena sa dve paralelne prave na jedini\v cnoj udaljenosti. Ta\v cnije, Zalgaler je prona\v sao najkra\' ci put jedini\v cne \v sirine, a kasnije je pokazano da je to najkra\' ci izlazni put iz posmatrane \v sume. Tako\dj e su istra\v zivani i najkra\' ci putevi jedini\v cne \v sirine u vi\v sim dimenzijama. Gomi je poo\v strio gornje ograni\v cenje za du\v zinu takvog puta u prostoru i prona\v sao donje ograni\v cenje za du\v zinu takvog puta u $\mathbb{R}^n$. U ovom radu \' cemo predstaviti jedno gornje ograni\v cenje za du\v zinu najkra\' ceg puta jedini\v cne \v sirine u $\mathbb{R}^n$, kao i jednu modifikaciju Belmanovog problema u kojoj vi\v se ljudi kre\' ce iz iste ta\v cke i smatra se da su iza\v sli iz \v sume ako je barem jedan od njih iza\v sao i za du\v zinu puta se smatra suma du\v zina pojedina\v cnih puteva. Dalje je pokazano jedno gornje i jedno donje ograni\v cenje za du\v cinu najkra\' ceg puta jedinične \v sirine u $\mathbb{R}^n$ pri posmatranoj modifikaciji problema, kao i dokaz optimalnosti jedne modifikovane putanje u ravni pri restrikciji konveksnog omota\v ca puta na trougao. Dosada\v snji rad i intuicija ukazuju na to da je pri posmatranoj modifikaciji u $\mathbb{R}^n$ najkra\' ci put jedini\v cne \v sirine ba\v s put za $(n+1)$-nog \v coveka konstruisan u ovom radu.
...
\bigskip
U ovom radu posmatramo uop\v stenje Belmanovog problema u $\mathbb{R}^n$, u originalnu, kao i pri modifikaciji za vi\v se ljudi navedenoj u prethodnom odeljku.
\\
\\
...
\\
\\
\indent Tre\' ce poglavlje se bavi donjim ograni\v cenjem za du\v zinu najkra\' ceg izlaznog puta iz \v suma posmatranih u poglavlju 2, u zavisnosti od toga koliko ljudi pou\v sava da iza\dj e iz \v sume.
\\
\\
...
\\
\\
\indent \v Sume ovog oblika su ve\' c posmatrane u kontekstu ispitivanja \v sirina putanja, po\v sto va\v zi ekvivalencija izme\dj u toga da $n$-dimenzioni put ima \v sirinu barem jedan i da je izlazna za \v sumu $T_n$. Gomi je 2018. pokazao da va\v zi:
\smallskip
\begin{teo}[Gomi] 
...
Gomi je pokazao gornje organi\v cenje za du\v zinu puta \v sirine 1. Konstrui\v simo put za jednog \v coveka koji koriste\' ci Gomijevo ograni\v cenje, daje donje ograni\v cenje za du\v zinu modifikovanog puta.
...
I neka su $l_1, l_2,...,l_k$ redom du\v zine $\gamma_1, \gamma_2,..., \gamma_k$, pri uslovu da su $l_1, l_k\leqslant \min(l_2,l_3,...l_{k-1})$
...
\indent Po\v sto je du\v zina posmatranog puta za $k$ ljudi $l_1+l_2+...+l_k$, a po\v sto su $l_1$ i $l_k$ najkra\' ce od ovih du\v zina, tada va\v zi:
$$l_1+l_2+...+l_k\geqslant \frac{k}{2k-2}\cdot (l_1+2\cdot(l_2+l_3+...l_{k-1})+l_k)$$
$$\Longrightarrow S_k\geqslant \frac{k}{2k-2}\cdot \sqrt{2.2782^2+9(n-2)}$$
$\square$
\end{proof}
